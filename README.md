...
It's the starting point to interact with the redstone, and every node provides a swagger API to make this interaction easier. Available endpoints:
...
# Run two nodes
$ node bin/red.js -p 3001 --name 1
$ node bin/red.js -p 3002 --name 2 --peers http://localhost:3001
...
# Run redstone in a docker
$ ./dockerExec.sh

# Run redstone in a docker using port 3002
$ ./dockerExec.sh -p 3002

# Run redstone in a docker options
$ ./dockerExec.sh -h
...
$ node bin/redstone.js -h
Usage: bin\redstone.js [options]
